...
impl Node {
    pub fn new_expression_statement(node: Option<Rc<Node>>) -> Option<Rc<Node>> {
        Some(Rc::new(Node::ExpressionStatement(node)))
    }
    ...
    pub fn new_numeric_literal(value: u64) -> Option<Rc<Node>> {
    ...
    pub fn new_identifier(name: String) -> Option<Rc<Node>> {
        Some(Rc::new(Node::Identifier(name)))
    }

    pub fn new_string_literal(value: String) -> Option<Rc<Node>> {
        Some(Rc::new(Node::StringLiteral(value)))
    }

    pub fn new_block_statement(body: Vec<Option<Rc<Node>>>) -> Option<Rc<Node>> {
        Some(Rc::new(Node::BlockStatement { body }))
    }

    pub fn new_return_statement(argument: Option<Rc<Node>>) -> Option<Rc<Node>> {
